...
export class ERC20DepositInitiated extends Entity {
  ...
  set _from(value: Bytes | null) {
    if (!value) {
      this.unset("_from");
    } else {
      this.set("_from", Value.fromBytes(<Bytes>value));
    }
  }
...
export class User extends Entity {
  ...
  get ethDeposits(): ETHDepositInitiatedLoader {
    return new ETHDepositInitiatedLoader(
      "User",
  ...
  get withdrawals(): ETHWithdrawalFinalizedLoader {
    return new ETHWithdrawalFinalizedLoader(
      "User",
      this.get("id")!.toString(),
      "withdrawals"
    );
...
export class ETHDepositInitiatedLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): ETHDepositInitiated[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<ETHDepositInitiated[]>(value);
  }
}

export class ETHWithdrawalFinalizedLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): ETHWithdrawalFinalized[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<ETHWithdrawalFinalized[]>(value);
  }
}
