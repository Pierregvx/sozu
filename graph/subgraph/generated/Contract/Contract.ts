...
export class Contract extends ethereum.SmartContract {
  ...
  try_l1MantleAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "l1MantleAddress",
      "l1MantleAddress():(address)",
      []
...
export class FinalizeMantleWithdrawalCall extends ethereum.Call {
  get inputs(): FinalizeMantleWithdrawalCall__Inputs {
    return new FinalizeMantleWithdrawalCall__Inputs(this);
  }

  get outputs(): FinalizeMantleWithdrawalCall__Outputs {
    return new FinalizeMantleWithdrawalCall__Outputs(this);
  }
}

export class FinalizeMantleWithdrawalCall__Inputs {
  _call: FinalizeMantleWithdrawalCall;

  constructor(call: FinalizeMantleWithdrawalCall) {
    this._call = call;
  }
...
export class FinalizeMantleWithdrawalCall__Outputs {
  _call: FinalizeMantleWithdrawalCall;
